...
<div class="row">
  ...
  <div class="column full">
	...
	<h4 style="text-align:left; padding-left: 40px;">Languages: Python, JAVA, C/C++, HTML/CSS/JS, React, Angular, NodeJS, Kotlin, GraphQL, TypeScript, MATLAB, AutoCAD</h4>
	<h4 style="text-align:left; padding-left: 40px;">Databases/Frameworks: MongoDB, Cassandra, Kafka, DynamoDB, Flask, Spring, Docker, Kubernetes, Rest API, .NET, SQL</h4>
	<h4 style="text-align:left; padding-left: 40px;">ML Libraries: Pandas, NumPy, Matplotlib, Selenium, BeautifulSoup, Scikit-learn, OpenCV, PyTorch, Keras, TensorFlow</h4>
	<h4 style="text-align:left; padding-left: 40px;">Tools/Operating Systems: AWS, CI/CD, Agile, Jupyter, Google Colab, IntelliJ, VS Code, Git, iOS, Linux, Windows, MacOS</h4>
	<h4 style="text-align:left; padding-left: 40px;">Interfaces/Technologies: UART, I2C, I2S, SPI, PCI, SIMD, PLC, UML, WiFi, Bluetooth/BLE, Ethernet, TCP/IP, ARM</h4>
	<h4 style="text-align:left: padding-left: 40px;">Transferable: Research, Problem Solving, Time Management, Database management, Teamwork and Collaboration</h4><br>
